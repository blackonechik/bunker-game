	...
	return (
		<section className={`text-center space-y-8 ${className}`}>
			<div className="inline-block relative">
				<h1 className="text-5xl md:text-8xl font-black uppercase tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-zinc-100 via-zinc-400 to-zinc-600">
						ОБ АВТОРАХ
					</h1>
