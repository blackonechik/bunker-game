  ...
  return (
    <div className="fixed inset-0 z-[200] flex pointer-events-none">
      ...
      <motion.div
        ...
        className="w-1/2 h-full bg-zinc-900 border-r-4 border-zinc-800 relative flex items-center justify-end"
      >
        {/* Декор двери */}
        ...
        {/* Замок */}
        <div className="w-24 h-24 rounded-full border-8 border-zinc-700 bg-zinc-800 mr-[-52px] z-10 flex items-center justify-center shadow-2xl">
          <motion.div
            animate={{ rotate: 360 }}
            transition={{
              duration: 3,
