...
const CARD_ACCENT_MAP: Record<CardType, CardAccentClasses> = {
  ...
  [CardType.SPECIAL]: {
    ...
    hudBar: 'bg-green-500',
    listItem: 'border-green-500 text-green-400',
  },
};
